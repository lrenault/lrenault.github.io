...
<div id="phd_SU2024" class="paper">
    <div class="paper-info">
        ...
        <div class="paper-data">
            ...
            <a class="paper-data-item" href="https://renault.gitlab-pages.ircam.fr/thesis-support" target="_blank" rel="noopener noreferrer">&#127760; Supplementary Materials</a>
...
<div id="unpair-perf-render_dafx23" class="paper">
    <div class="paper-info">
        ...
        <div class="paper-data">
            ...
            <a class="paper-data-item" href="http://renault.gitlab-pages.ircam.fr/dafx23/performance/rendering/2023/05/10/sup_mat" target="_blank" rel="noopener noreferrer">&#127760; Supplementary Materials</a>
            <a class="paper-data-item" onclick='copy_bibtext(this)'>&#128278; BibTeX</a>
        </div>
        <button class="paper-abstract-toggle" onclick='toggle_abstract(this)'>Click to read abstract</button>
...
<div id="deep-phonotactic_icassp21" class="paper">
    <div class="paper-info">
        ...
        <div class="paper-data">
            ...
            <a class="paper-data-item" href="https://github.com/deezer/SingingLanguageIdentification" target="_blank" rel="noopener noreferrer"><i class="fa fa-code"></i> Dataset & Code</a>
            <a class="paper-data-item" onclick='copy_bibtext(this)'>&#128278; BibTeX</a>
        </div>
        <button class="paper-abstract-toggle" onclick='toggle_abstract(this)'>Click to read abstract</button>
